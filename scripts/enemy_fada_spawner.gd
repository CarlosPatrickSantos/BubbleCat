...
const ENEMY_FADA = preload("res://entities/enemy_fada.tscn")
...
func spawn_fada():
	...
	var fada_instance = ENEMY_FADA.instantiate()
	
	
	add_child(fada_instance)
	...
	fada_instance.position = Vector2(350, random_y)
